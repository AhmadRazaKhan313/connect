...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/dashboard/edit-entry',
            element: checkLogin(<EditEntry />)
        },
        {
        ...
        {
            path: '/dashboard/sent-invoices',
            element: checkLogin(<SentInvoices />)
        },
        {
        ...
        },
        {
            ...
            element: checkLogin(<UpdatePassword />)
        },
        {
            path: '/dashboard/update-profile',
            element: checkLogin(<UpdateProfile />)
        },
        {
            path: '/dashboard/add-extra-income',
            element: checkLogin(<AddExtraIncome />)
        },
        {
            path: '/dashboard/completed-extra-incomes',
            element: checkLogin(<CompletedExtraIncomes />)
        },
        {
            path: '/dashboard/pending-extra-incomes',
            element: checkLogin(<PendingExtraIncomes />)
        },
        {
